...
void onTick(CMovement@ this)
{
    ...
    if (rules !is null && rules.get_bool("showMenu") && rules.get_bool("disable_movement"))
	{
		...
		blob.setKeyPressed(key_inventory, false);
		blob.setKeyPressed(key_taunts, false);
		blob.setKeyPressed(key_map, false);
	}
